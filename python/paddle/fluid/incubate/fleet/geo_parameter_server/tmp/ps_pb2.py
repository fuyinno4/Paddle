...
_PSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='geo_trainer_param', full_name='paddle.PSParameter.geo_trainer_param', index=6,
...
_GEOTRAINERPARAMETER = _descriptor.Descriptor(
  name='GeoTrainerParameter',
  full_name='paddle.GeoTrainerParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dense_table', full_name='paddle.GeoTrainerParameter.dense_table', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sparse_table', full_name='paddle.GeoTrainerParameter.sparse_table', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='comm_batch', full_name='paddle.GeoTrainerParameter.comm_batch', index=2,
...
_PSPARAMETER.fields_by_name['geo_trainer_param'].message_type = _GEOTRAINERPARAMETER
_PSPARAMETER.fields_by_name['fs_client_param'].message_type = _FSCLIENTPARAMETER
_GEOTRAINERPARAMETER.fields_by_name['dense_table'].message_type = _DENSETABLEPARAMETER
_GEOTRAINERPARAMETER.fields_by_name['sparse_table'].message_type = _SPARSETABLEPARAMETER
...
DESCRIPTOR.message_types_by_name['GeoTrainerParameter'] = _GEOTRAINERPARAMETER
...
GeoTrainerParameter = _reflection.GeneratedProtocolMessageType('GeoTrainerParameter', (_message.Message,), dict(
  DESCRIPTOR = _GEOTRAINERPARAMETER,
  __module__ = 'ps_pb2'
  # @@protoc_insertion_point(class_scope:paddle.GeoTrainerParameter)
  ))
_sym_db.RegisterMessage(GeoTrainerParameter)
