...
class GeoSGD(DeviceWorker):
    ...
    def gen_worker_desc(self, trainer_desc):
        ...
        for src_table in self.fleet_desc_.geo_trainer_param.dense_table:
        ...
        for src_table in self.fleet_desc_.geo_trainer_param.sparse_table:
        ...
        self.fleet_desc_.geo_trainer_param.thread_num = trainer_desc.thread_num
